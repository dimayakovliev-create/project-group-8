...
def main():
    ...
    while True:
        ...
        completer_dictionary = {
            "add": contacts_dict,          # Подскажет имена для добавления/обновления
            "change": contacts_dict,       # Подскажет имена существующих контактов
            "phone": contacts_dict,        # Подскажет, чей номер телефона искать
            "add-email": contacts_dict,    # Подскажет имя для добавления email
            "add-birthday": contacts_dict, # Подскажет имя для добавления дня рождения
            "show-birthday": contacts_dict,# Подскажет имя для вывода дня рождения
            "search": None,                # Свободный текстовый поиск (подсказки скрыты)
            "all": None,                   # Аргументы не нужны
            "birthdays": None,
            "hello": None,
            "help": None,
            "exit": None,
        ...
        if command in ["close", "exit"]:
            ...
            print("Invalid command. Enter the argument for the command: add, change, phone, all, add-birthday, add-email, search, show-birthday, birthdays, exit, close, hello")
